    ...
    const handleConfirm = async (e) => {
      ...
      try {
        const formdata1 = {
          ...
          const reject='http://localhost:5000/api/v1/mis/updatecheck';
          let stationEndpoint;
          
            if (formData1.stationname === 'raipur') {
                stationEndpoint = 'http://localhost:5000/api/v1/mis/updatedb3';
            ...
            const kt=await axios.post(reject,formData1);
